...
pE	|void	|my_localeconv	|NN struct lconv *retbuf
#endif
pE	|int	|is_LC_NUMERIC_string_utf8|NN const char * string|const bool known_utf8
pE	|int	|is_LC_MONETARY_string_utf8|NN const char * string|const bool known_utf8
pE	|int	|is_LC_TIME_string_utf8|NN const char * string|const bool known_utf8
pE	|int	|is_LC_MESSAGES_string_utf8|NN const char * string|const bool known_utf8
...
S	|const char*|my_nl_langinfo|const nl_item item|NULLOK int * utf8ness
S	|unsigned|get_locale_string_utf8ness|const nl_item item|NN const char * string|const bool known_utf8
ST	|unsigned|get_nl_item_category_index|const nl_item item
#  else
S	|const char*|my_nl_langinfo|const int item|NULLOK int * utf8ness
S	|unsigned|get_locale_string_utf8ness|const int item|NN const char * string|const bool known_utf8
#    if defined(HAS_MBTOWC) || defined(HAS_MBRTOWC)
ST	|unsigned|get_nl_item_category_index|const int item
#    endif
#  endif
